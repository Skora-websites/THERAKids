...
('Occupational Therapy', 'occupational-therapy',
 ...
 'https://images.unsplash.com/photo-1594608661623-aa0bd3a69d98?auto=format&fit=crop&w=600&q=80',
...
('Speech Therapy', 'speech-therapy',
 ...
 'https://images.unsplash.com/photo-1544396821-4dd40b938ad3?auto=format&fit=crop&w=600&q=80',
...
('Social Group Training', 'social-group-training',
 ...
 'https://images.unsplash.com/photo-1602080858428-57174f9431cf?auto=format&fit=crop&w=600&q=80',
...
-- ==========================================
-- GALLERY (4 photos, matching the Gallery page fallbacks)
-- ==========================================

DELETE FROM gallery WHERE caption IN
  ('Sensory Room','Play Time','Waiting Area','Physical Therapy');

INSERT INTO gallery (image_path, caption, category, display_order, is_active) VALUES
('https://images.unsplash.com/photo-1594608661623-aa0bd3a69d98?auto=format&fit=crop&w=500&q=80', 'Sensory Room', 'Therapy', 1, 1),
('https://images.unsplash.com/photo-1502086223501-7ea6ecd79368?auto=format&fit=crop&w=500&q=80', 'Play Time', 'Activities', 2, 1),
('https://images.unsplash.com/photo-1544396821-4dd40b938ad3?auto=format&fit=crop&w=500&q=80', 'Waiting Area', 'Our Centre', 3, 1),
('https://images.unsplash.com/photo-1519689680058-324335c77eba?auto=format&fit=crop&w=500&q=80', 'Physical Therapy', 'Therapy', 4, 1);

-- ==========================================
-- BLOGS (2 published posts, matching the Blogs page fallbacks)
-- ==========================================

DELETE FROM blogs WHERE slug IN
  ('understanding-sensory-processing','speech-milestones-toddlers');
...
('Understanding Sensory Processing Disorder',
 ...
 '<p>Some children experience the world through their senses more intensely than others. Sounds feel louder, textures feel harsher, and busy environments can quickly become overwhelming. When these reactions start to interfere with daily life — dressing, eating, playing, or learning — it may be a sign of Sensory Processing Disorder (SPD).</p><h3>Common signs to watch for</h3><ul><li>Covering ears at everyday noises or reacting strongly to touch</li><li>Avoiding certain foods because of texture or temperature</li><li>Constant movement — spinning, crashing, or fidgeting — or avoiding movement altogether</li><li>Meltdowns in busy places like supermarkets or playgrounds</li></ul><h3>How occupational therapy helps</h3><p>Our occupational therapists use play-based sensory integration to help children gradually build tolerance and regulation. Therapy looks like fun — swings, climbing, tactile games — but each activity is chosen to target specific sensory systems and teach the nervous system to respond more comfortably.</p><p>With consistent support, children learn strategies to self-regulate, and parents learn how to set up sensory-friendly routines at home. Early support makes a remarkable difference.</p>',
 'https://images.unsplash.com/photo-1544396821-4dd40b938ad3?auto=format&fit=crop&w=1200&q=80',
 'Dr. Priya Sharma', 'Occupational Therapy',
 'Understanding Sensory Processing Disorder | TheraKids',
 'Learn about the signs of SPD and how occupational therapy can provide strategies for self-regulation.',
 'published', '2026-08-10 09:00:00'),
...
('Speech Milestones for Toddlers',
 ...
 '<p>Every child develops at their own pace, but language follows a fairly predictable path. Knowing the typical milestones helps you celebrate progress — and spot early when a little extra support could help.</p><h3>12 to 18 months</h3><p>First words appear, usually naming people and favourite objects. Your toddler understands simple requests like "come here" and points to show interest.</p><h3>18 to 24 months</h3><p>Vocabulary grows quickly — often 50 or more words — and two-word combinations begin: "more juice", "daddy go".</p><h3>2 to 3 years</h3><p>Sentences of three or more words, question words like "what" and "where", and speech that is mostly understood by familiar adults.</p><h3>When to seek an assessment</h3><ul><li>No words by 16 months</li><li>No two-word phrases by age 2</li><li>Loss of words or skills at any age</li><li>You simply feel something is different — trust your instincts</li></ul><p>Early intervention is the single biggest factor in speech outcomes. If you are unsure, a developmental screening takes less than an hour and gives you a clear picture of where your child stands.</p>',
 'https://images.unsplash.com/photo-1519689680058-324335c77eba?auto=format&fit=crop&w=1200&q=80',
 'Dr. Rahul Verma', 'Speech Therapy',
 'Speech Milestones for Toddlers | TheraKids',
 'A quick guide for parents on what to expect as your toddler develops their communication skills.',
 'published', '2026-08-22 09:00:00');
